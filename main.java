...
public class SimpleAudioPlayer
{
 ...
 audioInputStream =
 AudioSystem.getAudioInputStream(new File(filePath).getAbsolute
File());
 ...
 map.put("Aate Jaate Khoobsurat Aawara","Aate Jaate Khoobsurat Aawara.w
av");
...
");
 ...
 throws IOException, LineUnavailableException, UnsupportedAudioFile
Exception
 {
 switch (c)
 {
...
on
 ...
 public void resetAudioStream() throws UnsupportedAudioFileException, IOExc
eption,
...
!!");
 System.out.println("To add this song to your favorites, go to
option no. 7");
